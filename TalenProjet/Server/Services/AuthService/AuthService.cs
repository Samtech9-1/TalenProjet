...
namespace TalenProjet.Server.Services.AuthService
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<ServiceResponse<int>> Register(User user, string password)
        {
            ...
            return new ServiceResponse<int> { Data = user.Id, Message = "Le compte a été créé !" };
        }
        ...
        /*cration du token de connection*/
        ...
        public async Task<ServiceResponse<bool>> ChangePassword(int userId, string newPassword)
        {
            ...
            return new ServiceResponse<bool> { Data = true, Message = "le mdp a été changé !." };
        }
    }
}
